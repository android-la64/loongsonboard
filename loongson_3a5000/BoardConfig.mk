...
BOARD_LA_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product  # Here, LA comes from 'BOARD_SUPER_PARTITION_GROUPS'
BOARD_LA_DYNAMIC_PARTITIONS_SIZE := 2143289344 # (4GB/2 - 4M)
